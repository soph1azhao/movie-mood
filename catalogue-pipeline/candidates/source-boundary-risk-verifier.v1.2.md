...
LINEAGE SPECIFICATION BINDINGS:
  ...
  schemaSpec:     catalogue-pipeline/specs/source-boundary-risk-verifier.v1.2.schema-spec.json (sha256:504bc9e389da934e607302fb7ce0b7058711c1ae1cd519a794fe3ae4b44eca28)
  contractSpec:   catalogue-pipeline/specs/source-boundary-risk-verifier.v1.2.spec.md (sha256:b12a45f2c1171deb7aab40095532c00e8ed12f444e363ec2529b3315a0b480ff)
  predecessorPrompt: catalogue-pipeline/prompts/source-boundary-risk-verifier.v1.1.md (sha256:361df6c2f5ca6feb3567c092e3f7bc5de7396f48b52e7a6c8afc9dbf00768123)
  predecessorSchema: catalogue-pipeline/schemas/source-boundary-risk-verifier.v1.1.schema.json (sha256:13edfc9ac97edf4f34739658b388706e8025727512e4fdb0671042c81d423947)
-->

# Source Boundary Risk Verifier v1.2
...
Return strictly structured JSON conforming to `source-boundary-risk-verifier.v1.2.schema.json`:

### If any material issue is detected:
Set `riskLevel: "HIGH_RISK"`, `sourceBoundarySatisfied: false`.
...
All 10 coverage booleans must be explicitly `true`:
