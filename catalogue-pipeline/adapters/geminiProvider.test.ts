...
describe('Gemini model provider', () => {
  ...
  it('projects Phase 5B structured grounding with candidate-specific cue references', () => {
    ...
    expect(evidenceItem.properties.rationale.minLength).toBe(12)
    expect(evidenceItem.properties.grounding.properties.cues.items.properties.cue.minLength).toBe(8)
    expect(evidenceItem.properties.grounding.properties.bridge.minLength).toBe(12)
